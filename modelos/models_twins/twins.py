...
class Twins(nn.Module):
    ...
    def __init__(
            self,
            img_size=32,
            patch_size=4, # podemos modificar el tamaño del parche o reducirlo
            in_chans=3,
            num_classes=1000,
            global_pool='avg',
            ...
            mlp_ratios=(4, 4, 4, 4),
            depths=(3, 4, 6, 3),
            # sr_ratios=(8, 4, 2, 1), antes
            sr_ratios=(2, 2, 1, 1), # cambio realizado para el modelo Twins-SVT para imagenes de 32x32
            wss=None,
            drop_rate=0.,
            pos_drop_rate=0.,
            proj_drop_rate=0.,
...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1000, 'input_size': (5, 32, 32), 'pool_size': None,
