...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=[4], in_chans=5, embed_dim=96, norm_layer=None):
        super().__init__()
...
class CrossFormer(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=[4], in_chans=5, num_classes=10,
                 embed_dim=96, depths=[2, 6, 6, 2], num_heads=[3, 6, 12, 24],
                 group_size=[4, 2, 2, 1], crs_interval=[8, 4, 2, 1], mlp_ratio=4., 
                 qkv_bias=True, qk_scale=None,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
                 norm_layer=nn.LayerNorm, ape=False, patch_norm=True,
                 use_checkpoint=False, merge_size=[[2], [2], [2]], use_cpe=True,
